...
I build full-stack web apps, RAG/AI pipelines, and automated backend workflows that turn business problems into shipped products — from client-facing platforms to systems that run themselves.

- Led a 5-person dev team through a bootcamp at Alliance Software and a capstone project that won Most Innovative Capstone Project
- Fine-tuned a model to detect AI-generated code at 95.58% accuracy across 43,000+ samples
- Magna Cum Laude CS graduate, comfortable owning a project from architecture to deployment
